...
public class task02 {
	...
	public static void main(String[] args) {
		//원의 넓이,둘레, 삼각형의 넓이, 둘레, 사각형의 넓이 둘레를 구하는 것을 값을 입력 받아서 계산하는 프로그램 작성
		Scanner scanner = new Scanner(System.in);
		
		System.out.println("도형 선택(1:원, 2:삼각형, 3:사각형)");
		String strX = scanner.nextLine();
		int x = Integer.parseInt(strX);
		
		if(x == 1) {
			System.out.print("둘레, 넓이 선택(1/n)");
			String strV = scanner.nextLine();
